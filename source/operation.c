...
//输入
sbit sensorManiTop = P1^4; //机械臂在顶端位置感应
sbit sensorManiBut = P1^7; //机械臂在低端位置感应

sbit sensorPositionInput = P3^0; //进口位置感应
sbit sensorPositionOutput = P3^7; //出口位置感应
